...
/* SELECT EVENT_NAME AS eventName, COUNT_STAR AS countStar, SUM_TIMER_WAIT AS sumTimerWait, MIN_TIMER_WAIT AS minTimerWait, AVG_TIMER_WAIT AS avgTimerWait, MAX_TIMER_WAIT AS maxTimerWait, COUNT_READ_WRITE AS countReadWrite, SUM_TIMER_READ_WRITE AS sumTimerReadWrite, MIN_TIMER_READ_WRITE AS minTimerReadWrite, AVG_TIMER_READ_WRITE AS avgTimerReadWrite, MAX_TIMER_READ_WRITE AS maxTimerReadWrite, COUNT_READ_ONLY AS countReadOnly, SUM_TIMER_READ_ONLY AS sumTimerReadOnly, MIN_TIMER_READ_ONLY AS minTimerReadOnly, AVG_TIMER_READ_ONLY AS avgTimerReadOnly, MAX_TIMER_READ_ONLY AS maxTimerReadOnly FROM performance_schema.events_transactions_summary_global_by_event_name */
/**
*/
