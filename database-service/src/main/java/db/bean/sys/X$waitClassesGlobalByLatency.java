...
/* SELECT event_class AS eventClass, total AS total, total_latency AS totalLatency, min_latency AS minLatency, avg_latency AS avgLatency, max_latency AS maxLatency FROM sys.x$wait_classes_global_by_latency */
/**VIEW
*/
