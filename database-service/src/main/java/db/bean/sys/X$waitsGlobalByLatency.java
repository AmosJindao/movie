...
/* SELECT events AS events, total AS total, total_latency AS totalLatency, avg_latency AS avgLatency, max_latency AS maxLatency FROM sys.x$waits_global_by_latency */
/**VIEW
*/
