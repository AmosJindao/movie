...
/* SELECT object_schema AS objectSchema, object_name AS objectName, rows_full_scanned AS rowsFullScanned, latency AS latency FROM sys.x$schema_tables_with_full_table_scans */
/**VIEW
*/
