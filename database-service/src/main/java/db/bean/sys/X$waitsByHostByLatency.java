...
/* SELECT host AS host, event AS event, total AS total, total_latency AS totalLatency, avg_latency AS avgLatency, max_latency AS maxLatency FROM sys.x$waits_by_host_by_latency */
/**VIEW
*/
