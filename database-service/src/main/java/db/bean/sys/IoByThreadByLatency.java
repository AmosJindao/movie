...
/* SELECT user AS user, total AS total, total_latency AS totalLatency, min_latency AS minLatency, avg_latency AS avgLatency, max_latency AS maxLatency, thread_id AS threadId, processlist_id AS processlistId FROM sys.io_by_thread_by_latency */
/**VIEW
*/
